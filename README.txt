...
Contributors: galusaro
Donate link: https://www.facebook.com/Luis-script-kiddie
Tags: 1.0.0
Stable tag: 1.0.0
...
Simple Login with FB is plugin that helps you to create a link in your nav bar.
...
1. Download plugin
2. Activate plugin
3. Fill up with the required info
